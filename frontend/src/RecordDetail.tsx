  ...
  return (
    <section className="detail-pane" aria-label="Selected email">
      ...
      <article className="panel">
        <section className="detail-group message-group" aria-label="Original message">
        ...
        <section className="detail-group triage-group" aria-label="Local triage">
          <div className="kv">
        ...
        <section className="detail-group routing-group" aria-label="Privacy routing">
          <div className="kv">
        ...
        <section className="detail-group draft-group" aria-label="Draft reply">
